        ...
        <div data-anim-wrap className="container">
          <div className="row y-gap-50 items-center justify-between">
            <div className="col-lg-5 col-md-9">
              ...
              >
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates corrupti quasi dignissimos obcaecati exercitationem expedita totam recusandae architecto sequi eum explicabo, quae aperiam vero atque.
              </p>
              <div
              ...
              >
                <div className="col-sm-4 col-auto">
                  <div className="text-92 sm:text-60 text-sec fw-500">22</div>
                  <div className="text-17 fw-500 uppercase">ROOMS</div>
                </div>

                <div className="col-sm-4 col-auto">
                  <div className="text-92 sm:text-60 text-sec fw-500">14</div>
                  <div className="text-17 fw-500 uppercase">SUITS</div>
                </div>

                <div className="col-sm-4 col-auto">
                  <div className="text-92 sm:text-60 text-sec fw-500">17</div>
                  <div className="text-17 fw-500 uppercase">RESTAURANTS</div>
                </div>
              </div>
            </div>
